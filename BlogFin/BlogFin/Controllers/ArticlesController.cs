...
namespace BlogFin.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Content,AuthorID")] Article article)
        {
            ...
            ViewBag.AuthorID = new SelectList(db.ApplicationUsers, "Id", "FullName", article.AuthorID);
            return View(article);
        }
